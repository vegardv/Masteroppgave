#ifndef __c4_test_h__
#define __c4_test_h__
...
#ifndef typedef_SFc4_testInstanceStruct
#define typedef_SFc4_testInstanceStruct
...
typedef struct {
  ...
  uint8_T c4_is_active_c4_test;
} SFc4_testInstanceStruct;

#endif                                 /*typedef_SFc4_testInstanceStruct*/
...
extern void c4_test_method_dispatcher(SimStruct *S, int_T method, void *data);
